...
3. (اختياري) فلتر بالجروب أو الراوند أو الباتش أو التراك (Technical / Non-Technical).
   ...
   في خانة **Group Names** تدوس على الخانة فتفتحلك **قائمة بكل الجروبات** بسكرول، وتقدر تكتب فيها عشان تفلتر. كل جروب تختاره بيظهر فوق الخانة كـ **chip مرقّم** وجنبه علامة **×** لو عايز تشيله، وفيه **Clear all** لو عايز تمسحهم كلهم.

   - الترتيب مهم: الجروبات بتشتغل واحد ورا التاني بنفس ترتيب اختيارك.
   - سحب الحضور بيطلب من الـ Dashboard **السيشنز بتاعة الجروبات دي بس** مش كل سيشنز المدى الزمني. يعني 5 سيشنز بدل 366 لما تختار 3 جروبات.
   - الراوند بيتبعت في نفس الطلب (`round=second` للراوند 5).
   - سيبها فاضية لو عايز كل الجروبات. زرار **Edit Dashboard Link** بياخد جروب واحد بس.
...
### ♻️ خانة Re-upload sessions that already have attendance

في الوضع العادي السيشن اللي غيابها متاخد على الـ LMS بتتعدّى. لو الغياب اتاخد **غلط** وعايز تستبدله، علّم على الخانة دي قبل ما تدوس **Upload Attendance** أو **Run Everything**: هيفتح Change attendance ويرفع الـ CSV من تاني ويستبدل الغياب اللي موجود.

- بيسألك تأكيد ويوريك التواريخ والجروبات اللي هيشتغل عليها.
- ضيّق النطاق بالتواريخ والجروبات الأول عشان ما تلمسش سيشنز مش قاصدها.
- الخانة **مش بتتحفظ**: كل ما تفتح التطبيق بتلاقيها فاضية.
